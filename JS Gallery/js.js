...
const gallery = {
  settings: {
    ...
    openedImageCloseBtnSrc: 'images/gallery/circle.png',
    openedImage404Eror: 'images/404.png',
  },
  ...
  createScreenContainer() {
    ...
    image.addEventListener('error', () => this.openImage(this.settings.openedImage404Eror)) //  слушатель для 404.
    
    // console.log(this.settings.openedImageClass);
